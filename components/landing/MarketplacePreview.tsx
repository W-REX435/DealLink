      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal className="mx-auto mb-12 max-w-2xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted sm:text-lg">
            ...
            and audience size. Full marketplace launching soon.
          </p>
        </Reveal>
          ...
          <div className="mx-auto mb-10 flex max-w-2xl flex-col gap-3 sm:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-surface py-3 pl-11 pr-4 text-sm font-medium text-foreground placeholder:text-muted-2 shadow-soft transition-all focus:border-accent/50 focus:outline-none focus:ring-2 focus:ring-accent/20"
              />
            </div>
